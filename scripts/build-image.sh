...
unshare --user --map-root-user --map-auto --mount chroot build/image/rootfs dpkg-query -W > dist/ungoggled-image-packages.txt
...
out=dist/ungoggled-0.2.0-pi4-arm64.img
